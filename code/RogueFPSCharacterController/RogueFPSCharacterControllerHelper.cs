...
internal struct RogueFPSCharacterControllerHelper
{
	//
	// Inputs and Outputs
	//
	...
	public RogueFPSCharacterControllerHelper( PhysicsTraceBuilder trace, Vector3 position, Vector3 velocity ) : this()
	{
		Velocity = velocity;
		Position = position;
		Bounce = 0.0f;
